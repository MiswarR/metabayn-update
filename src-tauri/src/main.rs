...
fn main() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::api::resize_media_batch,
            crate::api::convert_media_batch,
            crate::api::list_convert_formats,
            crate::api::prompt_grabber_scan_folder,
            crate::api::prompt_grabber_scan_folder_fast,
            crate::api::prompt_grabber_get_thumbnails,
