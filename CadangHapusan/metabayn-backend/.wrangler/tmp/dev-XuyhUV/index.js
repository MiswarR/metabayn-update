...
// .wrangler/tmp/bundle-vaOBXx/checked-fetch.js
...
// .wrangler/tmp/bundle-vaOBXx/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-vaOBXx/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
    ...
    try {
      ...
      if (path.startsWith("/admin/")) {
        ...
        if (path === "/admin/debug/vertex/cb-reset" && method === "POST") {
          cbReset();
          return await wrapCors(new Response(JSON.stringify({ ok: true }), { headers: corsHeaders }));
        }
