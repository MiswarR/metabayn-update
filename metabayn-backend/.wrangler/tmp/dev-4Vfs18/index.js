...
// .wrangler/tmp/bundle-KR5PsF/checked-fetch.js
...
__export(admin_exports, {
  ...
  handleSeedUsers: () => handleSeedUsers2,
...
async function handleSeedUsers2(request, env) {
  try {
...
var init_admin = __esm({
  "src/handlers/admin.ts"() {
    ...
    __name(handleSeedUsers2, "handleSeedUsers");
...
// .wrangler/tmp/bundle-KR5PsF/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-KR5PsF/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
  ...
  async fetch(request, env, _ctx) {
    ...
    try {
      ...
      if (path.startsWith("/admin/")) {
        ...
        if (path === "/admin/users/seed") return await wrapCors(handleSeedUsers(request, env));
