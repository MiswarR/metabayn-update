    ...
    en: {
      ...
      settings: {
        ...
        items: [
          ...
          { title: "AI Provider", desc: "Choose the AI service backend (OpenAI, Gemini, or AI Gateway). Each has different strengths and pricing." },
          ...
          { title: "API Key", desc: "Enter your personal API Key for the selected provider (OpenAI, Gemini, or AI Gateway). This key is stored locally on your device." },
      ...
      usage: {
        ...
        items: [
          ...
          { title: "5. Stopping", desc: "Click 'Stop' (■) to stop adding new files and finish current tasks." },
    ...
    id: {
      ...
      settings: {
        ...
        items: [
          ...
          { title: "AI Provider", desc: "Pilih backend layanan AI (OpenAI, Gemini, atau AI Gateway). Masing-masing memiliki kelebihan dan harga berbeda." },
          ...
          { title: "API Key", desc: "Masukkan API Key pribadi Anda untuk provider yang dipilih (OpenAI, Gemini, atau AI Gateway). Kunci ini disimpan secara lokal di perangkat Anda." },
      ...
      usage: {
        ...
        items: [
          ...
          { title: "5. Berhenti", desc: "Klik 'Stop' (■) untuk menghentikan penambahan file baru dan menyelesaikan proses yang sedang berjalan." },
